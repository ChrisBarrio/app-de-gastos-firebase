...
const Opcion = styled.div`
  ...
  &:active{
    background-color:${theme.verde};
  }
`;

const SelectCategorias = ({ categoria, cambiarCategoria }) => {
  const [mostrarSelect, cambiarMostrarSelect] = useState(false);
  //Lista de ejemplo(en caso de sumar categoria modificar 'useObtenerGastosDelMesPorCategoria')
  const categorias = [
  ...
  //esta funcion mantiene la categoria seleccionada
  const handleClick = (e) => {
